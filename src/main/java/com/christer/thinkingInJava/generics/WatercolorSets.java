package com.christer.thinkingInJava.generics;//: generics/WatercolorSets.java
import com.christer.thinkingInJava.generics.watercolors.*;
import java.util.*;
import static net.mindview.util.Print.*;
import static net.mindview.util.Sets.*;
import static com.christer.thinkingInJava.generics.watercolors.Watercolors.*;
